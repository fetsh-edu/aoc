...
let get_solver day =
  ...
  | 5 ->
    ...
    | 6 ->
      ...
      Ok (module Solver : Day.Solver)
    | 7 ->
      let module Solver = Day07 in
      Ok (module Solver : Day.Solver)
    | 8 ->
      let module Solver = Day08 in
      Ok (module Solver : Day.Solver)
    | 9 ->
      let module Solver = Day09 in
      Ok (module Solver : Day.Solver)
    | 10 ->
      let module Solver = Day10 in
      Ok (module Solver : Day.Solver)
    | 11 ->
      let module Solver = Day11 in
      Ok (module Solver : Day.Solver)
    | 12 ->
      let module Solver = Day12 in
      Ok (module Solver : Day.Solver)
